    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">JMO HOTEL & RESORTS</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/gambar/Gambar Hotel 1.jpg" alt="First slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/Gambar Hotel 2.jpg" alt="Second slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/Gambar Hotel 4.jpg" alt="Third slide" height="450">
                      </div>
                    </div>
            ...
            <div class="card">
              <div class="col-md-12">
                <div class="card-body">
                  ...
                  <p class="text-center">Selamat Datang di JMO HOTEL liburan keluarga semua menjadi bahagia</p>
                </div>
              </div>
            </div>          
          </div><!-- /.container-fluid -->
